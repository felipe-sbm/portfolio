...
export const Projects = {
  spiral: {
    ...
    className:
      "bg-gradient-to-r from-blue-500 via-purple-500 to-fuchsia-800",
  },
  calculus: {
    ...
    className:
      "bg-gradient-to-r from-amber-400 via-orange-400 to-orange-600",
  },
  wetasks: {
  ...
  piaf: {
    ...
    date: "2024-09-08",
    image: "https://github.com/felipe-sbm/piaf-ufrn/assets/129466661/5aa37c27-d409-44d7-90fe-b22306d950bb",
    alt: "The PIAF logo",
    tags: ["Python 3", "Node.js", "Electron", "Flask", "Boostrap"],
    className:
      "bg-gradient-to-r from-red-400 via-red-600 to-red-900",
  },
  shalom: {
    ...
    date: "2024-18-07",
    image: "https://raw.githubusercontent.com/felipe-sbm/shalom/main/public/album.png",
    alt: "Orchestra Shalom's album of photos at anivessary.",
    tags: ["Typescript", "Next.js", "TailwindCSS"],
    className:
      "bg-gradient-to-r from-cyan-500 via-sky-500 to-blue-800",
  },
  insomnia: {
    ...
    tags: [""],
    className:
      "bg-gradient-to-r from-pink-400 via-fuchsia-500 to-purple-800",
  },
  voragio: {
    ...
    className:
      "bg-gradient-to-r from-zinc-400 via-gray-500 to-slate-800",
  },
  token: {
    ...
    className:
      "bg-gradient-to-r from-rose-500 via-sky-500 to-green-500",
  },
  cuscuz: {
    ...
    date: "2024-14-02",
    image: "https://raw.githubusercontent.com/felipe-sbm/math/4313ade86c7a9199c4b8c3a852439dd609385536/public/static/images/twitter-card.png",
    alt: "The cuscuz logo",
    tags: [""],
    className:
      "bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-800",
  },
};
