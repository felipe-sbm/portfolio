  ...
  <div class="justify-center">
    ...
    <p class="font-light subpixel-antialiased text-zinc-900 dark:text-zinc-300">
      I'm a fullstack developer, computer engineer, software student and webdesigner since 2019. I worked in <a
        href="https://github.com/felipe-sbm/piaf-ufrn" alt="Link for the PIAF - UFRN repository"><span
          ...
          <svg width="208" height="208" viewBox="0 0 208 208" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
              ...
              stroke="#980F0F" stroke-width="16" />
          </svg>
          PIAF - UFRN
        </span></a>
      and made some
      projects in my own, like <a href="https://github.com/felipe-sbm/spiral"
        alt="Link for the Spiral SBM repository"><span
          ...
          <svg viewBox="0 0 515 515" fill="none" xmlns="http://www.w3.org/2000/svg"
            ...
            <defs>
              <filter id="filter0_i_138_2" x="37.9985" y="38.0005" width="446.001" height="449.012"
    ...
    <p class="font-light mb-8 subpixel-antialiased text-zinc-900 dark:text-zinc-300">
      Currently I'm working at project <a href="https://spiral-sbm.vercel.app"
        class="underline text-zinc-950 dark:text-zinc-50" alt="Link for the Spiral SBM website">Spiral SBM</a>. I
      actually work as a Freelancer, making
    ...
    <TeachPages />
    <span class="hidden">
      <a href="https://felipe-sbm.blogspot.com/" alt="Link for my blog">Blog Link</a><br>
      <a href="https://www.youtube.com/@felipe_sbm" alt="Link fot my youtube channel">YouTube Link</a>
    </span>
  </div>
</template>
